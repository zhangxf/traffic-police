...
public class IHangmeiHttpClientUtil {
	
	protected final Log LOG = LogFactory.getLog(IHangmeiHttpClientUtil.class);
	private static IHangmeiHttpClientUtil instance;
	protected Charset charset;
	
	private IHangmeiHttpClientUtil(){}
	
	public static IHangmeiHttpClientUtil getInstance() {
		return getInstance(Charset.defaultCharset());
	}
	
	public static IHangmeiHttpClientUtil getInstance(Charset charset){
        if(instance == null){
            instance = new IHangmeiHttpClientUtil();
        }
	...
	public static void main(String[] args) throws Exception {
		...
		params.put("server", "uc-prod-1");
		params.put("ip", "172.168.138.2");
		params.put("message", "param.error.88");
		params.put("priority", "6");
		params.put("extra", "Exception in thread \"main\" java.lang.NullPointerException\n at com.ihangmei.http.HttpClientUtil.main(HttpClientUtil.java:349)");
		String s = client.doPost("http://127.0.0.1:8091/collect-message/servermsg/insert", params);
